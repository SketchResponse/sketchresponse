...
problemconfig = sketchresponse.config({
    ...
    'plugins': [
        {'name': 'axes'},
        {'name': 'freeform', 'id': 'f', 'label': 'Freeform', 'color':'blue'},
        {'name': 'vertical-line', 'id': 'va', 'label': 'Vertical line', 'color': 'gray', 'dashStyle': 'dashdotted'},
        {'name': 'horizontal-line', 'id': 'ha', 'label': 'Horizontal line', 'color': 'gray', 'dashStyle': 'dashdotted'},
        {'name': 'point', 'id': 'cp', 'label': 'Point tool', 'color': 'black', 'size': 15},
        {'name': 'point', 'id': 'ip', 'label': 'Open point', 'color':'Orange','size': 15, 'hollow':True},
        {'name': 'line-segment', 'id': 'lineseg', 'label': 'Dashed line', 'color': 'Brown', 'size': 15, 'dashStyle':'longdashed'},
        {'name': 'line-segment', 'id': 'arw', 'label': 'Arrow', 'color': 'DarkGreen', 'size': 15,'arrowHead': {'length': 10, 'base': 7}},
        {'name': 'line-segment', 'id': 'carw', 'label': 'Constrained Arrow', 'color': 'Indigo', 'size': 15, 'directionConstraint': 'horizontal', 'lengthContraint': 5, 'arrowHead': {'length': 10, 'base': 7}}
    ]
})

@sketchresponse.grader
def grader(f,cp,ip,va,ha,lineseg,arw,carw):
